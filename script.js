...
function agregar(){
    let desicion = Number(prompt("Para ingresar un array con elementos ya pre-cargados) pulsar 1. Para ingresarlos manual, ponga 2:"))
        if (desicion == 1 && noCargarListaDosVeces) {
            for (const iterator of arrayEjemplo) {
            productos.push(iterator)
            }
            console.log("Se ha cargado la lista aleatoria\n\n")
        ...
        alert("No puede ingresar dos veces la lista de prueba. Si quiere agregar mas elementos, seleccione la forma manual.")
    }else if (desicion==2){
        let flag=true;
        let opcion2=true;
        let opcion3=true;
        ...
        do {
            if (flag) {
                ...
                let id;
                do {
                    id = Number(prompt("Ingresar el ID del producto"));
                    if(!id || isNaN(id)){
                        alert("Ingresó un ID inválido, intentelo nuevamente!")
                        opcion4=true;
                    }else{
                        controlDeID.push(id);
                        opcion4=false;
                ...
                let opcion = confirm("Agregar otro producto?");
                if (opcion) {
                    let id;
...
function eliminar(){
    if(productos.length==0){
        alert("Aun no ha cargado ningún producto a la lista")
    }else{
        productos.sort(function (a, b) {
            if (a.id > b.id) {
            return 1;
...
const arrayEjemplo = [
    {id: 5, prod: "Cerveza", marca: "Andes",  precio: 500},
    {id: 8, prod:"Cerveza", marca: "Brahma", precio: 300},
    {id: 12, prod:"Gancia", marca: "Gancia", precio: 800},
    {id: 16, prod:"Fernet", marca: "Branca", precio: 1000},
    {id: 1, prod:"Cerveza", marca: "Corona", precio: 20000},
    {id: 25, prod:"Gaseosa", marca: "Coca-Cola", precio: 650},
    {id: 4, prod:"Gin", marca: "Captain Morgan", precio: 980},
    ]
...
alert("Primero abrir la consola del inspector en el navegador de la PC, y luego ejecutar el programa!")
